  ...
  <span className="text-primary"> tecnologia e conhecimento</span>
          ...
          <div className="max-w-4xl mx-auto space-y-8 text-center">
            <p className="text-xl text-muted-foreground leading-relaxed">
              comecei no ano de 2026 a graduacão em segurança da informação, estava no 4 semestre da graduação em ciência da computação,
              acho que uma das coisas que me fez mudar de curso foi a perde de uma oportunidade  de estágio, e a oportunidade de estagiar em uma empresa muito boa na area de segurança da informação, e a partir dai comecei a me interessar mais por essa area, 
              e percebi que a segurança da informação é uma area muito importante e que tem muito a oferecer.
                          </p>
